...
export const PREMIUM_MATERIAL_IDS = {
  ...
  GRAVEL_STONE: 'gravel_stone',
  METEORITE_STONE: 'meteorite_stone',
};
...
export const PREMIUM_MATERIAL_LIBRARY = {
  ...
  [PREMIUM_MATERIAL_IDS.METEORITE_STONE]: {
    ...
    aoMapIntensity: 3.6,
    aoIntensity: 3.6,
    proceduralVariant: 'meteorite',
    displacementScale: 0.04,
    normalScale: 1.55,
    bumpScale: 0.26,
    sharpRelief: true,
  },
  [PREMIUM_MATERIAL_IDS.GRAVEL_STONE]: {
    label: 'Gravel',
    kind: 'stone',
    color: 0xffffff,
    metalness: 0.0,
...
const PRESET_ALIASES = {
  ...
  stoneware: PREMIUM_MATERIAL_IDS.METEORITE_STONE,
  ancient_stoneware: PREMIUM_MATERIAL_IDS.ANCIENT_STONEWARE,
  meteorite: PREMIUM_MATERIAL_IDS.METEORITE_STONE,
  meteorite_stone: PREMIUM_MATERIAL_IDS.METEORITE_STONE,
  gravel: PREMIUM_MATERIAL_IDS.GRAVEL_STONE,
  gravel_stone: PREMIUM_MATERIAL_IDS.GRAVEL_STONE,
